...
class List_edit extends StatefulWidget {
  to_do_list schedule;
  int index;
  List_edit({Key? key, required this.schedule, required this.index})
      : super(key: key);
  @override
  State<List_edit> createState() =>
      _HomeState(schedule: this.schedule, index: this.index);
}
          ...
          child: SingleChildScrollView(
            child: Column(children: [
                  ...
                  decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: Colors.tealAccent.shade700, width: 1.95)),
                      enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                              color: Colors.teal.shade700, width: 2.0)),
                      ...
                      child: ScrollConfiguration(
                        ...
                        child: GlowingOverscrollIndicator(
                          ...
                          child: ListView.builder(
                            itemCount:
                                (widget.schedule.item.length + item.length),
              ...
              Container(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        showDialog(
                          ...
                          builder: (context) {
                            return Add_taskBox(
                              item_addingController: _controller,
                              onSave: () {
                                setState(() {
                ...
                margin: EdgeInsets.fromLTRB(0.0, 25.5, 0.0, 0.0),
              ),
              Container(
                child: Row(
                  children: [
                    SizedBox(
                        ...
                        child: Directionality(
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              to_do_list n_ob = to_do_list(
                                  title: _title_controller.text,
                                  item: widget.schedule.item,
...
class Add_taskBox extends StatelessWidget {
  ...
  Add_taskBox(
      {super.key,
      required this.item_addingController,
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                      borderSide:
                          BorderSide(color: Colors.teal.shade700, width: 2.0)),
                  hintStyle: const TextStyle(
                      color: Colors.grey,
                      fontSize: 14.0,
                      fontFamily: "NotoSans",
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ButtonStyle(
                      ...
                      backgroundColor:
                          MaterialStateProperty.all(CupertinoColors.separator)),
                ),
                ElevatedButton(
                  onPressed: () {
                    onCancel();
